...
bottle_layers(N, Color1, Color2, S):-
    ...
    ;
    (
        S = result(pour(From, To), PreviousState) , 
        bottle_layers(1, Top1, Bottom1, PreviousState) , 
        bottle_layers(2, Top2, Bottom2, PreviousState) , 
        bottle_layers(3, Top3, Bottom3, PreviousState) ,
        (
            (
                From = 1 ,
                To = 3 ,(
